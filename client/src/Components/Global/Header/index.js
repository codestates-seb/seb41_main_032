...
const Header = () => {
    ...
    //TODO: memberInfo에 데이터가 있을때는 로그인을 한 상태입니다 memberInfo에 데이터가 있다면 로그인버튼을 수정해주세요

    return (
        <Main>
            <div className="logo">
                <Link to="/">
                    <svg className="icon" width="40" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                        <path
                            fill="#113CFC"
                            className="icon"
            ...
            <div className="search">
                <div>
                    <Search />
                    <svg className="sicon" width="20" height="60" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            ...
            <LogDiv>
                <Link to="/login">
                    <svg className="user" height="30" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
                            className="user"
